    ...
    <div class="row">
      ...
      <div class="col">
         <div class="input-group mb-3">
           ...
           <input type="text" class="form-control input-lg" aria-label="Sizing example input" name="username" required pattern="[A-Za-z0-9-ñ-Ñ ]+" title="Solo se aceptan letras de la [A-Z] o [a-z] y numeros" maxlength="40"aria-describedby="inputGroup-sizing-default" >
         </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default">Correo</span>
          <input type="email" required pattern="[A-Za-z0-9-ñ-Ñ ]+" title="Solo se aceptan letras de la [A-Z] o [a-z] y numeros" maxlength="40" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="email" >
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default"> Edad </span>
          <input type="text"required pattern="[0-9]+" title="Solo se aceptan numeros" maxlength="2" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="age" >
        </div>
      </div>
      ...
      <div class="col">
        <div class="input-group mb-3">
          ...
          <input type="text" required pattern="[A-Za-z0-9-ñ-Ñ ]+" title="Solo se aceptan letras de la [A-Z] o [a-z] y numeros" maxlength="40" class="form-control" aria-label="Sizing example input" name="surnames" aria-describedby="inputGroup-sizing-default">
        </div>    
        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default">Telefono</span>
          <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="phone" required pattern="[0-9 ]+" title="Solo se aceptan numeros" maxlength="10" >
        </div>
    ...
    <div class="row">
      <h5>Informacion de la cuenta</h5>
         ...
         <div class="row">
           <div class="col">        
                    <div class="input-group mb-3">
                      <input type="hidden" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="" >
                    </div>  
                    <div class="input-group mb-3">
                      <span class="input-group-text" id="inputGroup-sizing-default">usuario</span>
                      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required pattern="[A-Za-z0-9-ñ-Ñ ]+" maxlength="40" title="Solo se aceptan letras de la [A-Z] o [a-z] y numeros"  name="nickname" >
                    </div>        
              </div>
         ...
         <div class="row">
           <div class="col">        
                    ...
                    <span class="input-group-text" id="inputGroup-sizing-default">Contraseña</span>
                      ...
                      <input type="text" required pattern="[A-Za-z0-9-ñ-Ñ ]+" title="Solo se aceptan letras de la [A-Z] o [a-z] y numeros" maxlength="40" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="password" value="NiceCode_Team" />
                    </div>  
                    </div>  </div>  
          ...
          <div class="p-4 row justify-content-center" >
              ...
              <div class=" col " >
              <span class="float-right ">   <button type="reset" form="aceptar" name="rechazar" class="btn btn-warning ">Cancelar registro</button> </span>
